...
QUALITY_DATA = {
    ...
    "nano:std": {"cost": 5,  "payload": {"image_size": "1024x1024", "_nano_model": "google/nano-banana"}},
    "nano:hd":  {"cost": 10, "payload": {"image_size": "1536x1536", "_nano_model": "google/nano-banana-2"}},
    "nano:4k":  {"cost": 20, "payload": {"image_size": "2048x2048", "_nano_model": "google/nano-banana-pro"}},
