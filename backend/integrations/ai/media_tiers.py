...
class MediaTier:
    ...
    emoji: str = ""
    note: str = ""           # short helper text (resolution / duration)
...
def tiers_by_kind() -> dict[str, list[dict]]:
    """Grouped, serializable tier list for the API/UI."""
